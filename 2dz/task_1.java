...
public class task_1 {
    ...
    public static int[] bubble_sort(int[] array) throws SecurityException, IOException {
        ...
        Logger text_logger = Logger.getLogger(task_1.class.getName());
        FileHandler filetext = new FileHandler("D:/Java/Java/2dz/log_for_HW2.txt",
                true);
        text_logger.addHandler(filetext);
        SimpleFormatter sFormat = new SimpleFormatter();
        filetext.setFormatter(sFormat);
        // Запись логов в xml-файл.class.getName());
        Logger xml_logger = Logger.getLogger(task_1.class.getName());
        FileHandler file = new FileHandler("D:/Java/Java/2dz/log.xml", 104857600, 200,
                true);
